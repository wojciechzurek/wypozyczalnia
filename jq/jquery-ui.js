...
function Datepicker() {
	...
	this.regional[ "" ] = { // Default regional settings
		closeText: "Okej", // Display text for close link
		...
		monthNamesShort: [ "Sty", "Lut", "Mar", "Kwie", "Maj", "Czer", "Lip", "Sier", "Wrze", "Paźd", "List", "Gru" ], // For formatting
		dayNames: [ "Niedziela", "Poniedziałek", "Wtorek", "Środa", "Czwartek", "Piątek", "Sobota" ], // For formatting
		dayNamesShort: [ "Nied", "Pon", "Wto", "Śro", "Czw", "Pią", "Sob" ], // For formatting
		dayNamesMin: [ "Nd","Pn","Wt","Śr","Czw","Pt","So" ], // Column headings for days starting at Sunday
